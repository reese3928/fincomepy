...
df[["Zero Coupon Rate", "Coupon Cash Flow"]].to_csv(os.path.join("docs", "zspread_from_zero.csv"), index=False)
...
df[["Par Coupon Rate", "Coupon Cash Flow"]].to_csv(os.path.join("docs", "zspread_from_par.csv"), index=False)
